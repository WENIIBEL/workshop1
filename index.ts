...
personas.forEach(persona => console.log(persona.saludar()));
 const empleados:Empleado [] = [
    new Empleado (350,"juan",25,{"calle": 65,"ciudad": "medellin","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1"),
    new Empleado (250,"Kely",28,{"calle": 52,"ciudad": "bogota","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO, "n/a"),
    new Empleado (150,"Vilet",18,{"calle": 24,"ciudad": "pereira","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1"),
    new Empleado (526,"Jhona",36,{"calle": 14,"ciudad": "santa elena","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"n/a"),
    new Empleado (365,"Fredy",45,{"calle": 63,"ciudad": "bucaramanga","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1"),
    new Empleado (785,"Maili",23,{"calle": 22,"ciudad": "ibagué","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1"),
    new Empleado (265,"Noha",36,{"calle": 64,"ciudad": "armenia","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"n/a"),
    new Empleado (456,"Dante",30,{"calle": 9,"ciudad": "pasto","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1"),
    new Empleado (457,"Nicol",21,{"calle": 10,"ciudad": "manizales","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"n/a"),
    new Empleado (654,"Nicolas",20,{"calle": 32,"ciudad": "villavicencio","pais": "Colombia"},[new Coche("carro1","modelo1",2018)],EstadoCivil.CASADO,"departamento 1")
]
...
const departamento = new Departamento("dep",[empleados[0],empleados[2],empleados[5]])
departamento.añadirEmpleados(empleados[0])
departamento.eliminarEmpleado("departamento 1")
